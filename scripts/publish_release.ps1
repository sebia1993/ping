...
6. 사내 테스트 중 수정 요청을 만들려면 F12로 개발자 모드를 열고, 화면 또는 기능을 선택한 뒤 요청문을 복사합니다.
...
- 개발자 모드 요청문은 외부로 자동 전송되지 않으며, 회사 정보 마스킹은 기본 ON입니다.
- 비밀번호, 토큰, API 키와 인증정보는 마스킹 옵션과 관계없이 요청문에서 제거됩니다.
